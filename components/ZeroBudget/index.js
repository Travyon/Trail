...
import { List, Divider, Surface, FAB} from "react-native-paper";
...
const ZeroBudget =()=>{
    ...
    return(
        ...
        <Surface elevation={5} style={{height: 110, marginLeft: 30, marginRight: 30, marginTop: 125, borderRadius: 20, backgroundColor: 'black'}}>
        ...
        <Surface elevation={5} style={{height: 110, marginTop: 20, borderRadius: 20, backgroundColor:'black', shadowOpacity: 1, opacity: 10}}>
        ...
        <FAB
        icon= "plus"
        style={{ marginTop: 45, marginRight: 50, marginLeft:285, marginBottom: 20, backgroundColor: 'gold'}}
